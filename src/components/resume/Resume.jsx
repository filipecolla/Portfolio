          ...
          >
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-black shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                My tech journey started with a love for gaming and tinkering with Python since high school. Now, I'm honing skills in Java, JavaScript, and Python, as well as frameworks like React, React Native, and Spring Boot.
                </p>
              </div>
            </div>
          </fieldset>
